...
import { PlayIcon, XCircle } from "lucide-react";
...
const Creators = () => {
  ...
  return (
    <>
      <div className="flex w-full items-center justify-center flex-col p-5 mt-5 border-t border-gray-700">
      ...
      <div className="w-full md:w-9/12 mx-auto grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 p-5">
            ...
            {activeVideo === index ? (
              ...
              <>
                ...
                <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-0 group-hover:bg-opacity-50 transition duration-300 ease-in-out">
                  <PlayIcon className="h-12 w-12 text-white opacity-0 group-hover:opacity-100 bg-gray-800/50 backdrop-blur-md p-2 rounded-full border border-gray-500 translate-y-2 group-hover:-translate-y-3 transition-all duration-300" />
                </div>
              </>
            )}
          </div>
